    ...
    >
      ...
      >
        ...
        <el-form-item label="选择日期:" prop="bankCard" label-width="100px">
          <el-date-picker
            v-model="bankInCome.transactionTime"
            type="date"
            placeholder="选择日期"
          ></el-date-picker>
        </el-form-item>
        ...
        <el-form-item
          v-if="bankInCome_amount"
          label="交易金额:"
          label-width="100px"
        >
          <el-input
            v-model="bankInCome.transactionAmount"
            autocomplete="off"
          ></el-input>
        </el-form-item>

        <el-form-item
          v-if="bankInCome_bankProduct"
          label="选择理财产品:"
          label-width="100px"
        >
          <el-select
        ...
        <el-form-item
          v-if="bankInCome_transferCard"
          label="选择转入账号:"
          label-width="100px"
        >
          <el-select
            v-model="bankInCome.transferCar"
            clearable
            placeholder="选择转入账号"
          >
            <el-option value></el-option>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="submitBankIncome('bankIncomeForm')"
          >确 定</el-button
        >
      </div>
    </el-dialog>
